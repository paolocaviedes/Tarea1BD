<%-- 
    ...
    Created on : 18-04-2014, 07:28:28 AM
    Author     : Paolo
--%>
...
<%
       ...
       //String nombre= request.getParameter("nombre");
       String sql1 = "select * from bd.producto where id_producto='"+idproducto+"'";
       ...
       String nombre = datosproducto.getString("nombre");
